...
class CodeSearcher:
    ...
    def train(self, model):
        ...
        f1=open('/data/dengzhongyang/StbCS/keras/results/training_results.txt','a',encoding='utf-8',errors='ignore')
    ...
    def valid(self, model,K):
        ...
        for i in range(data_len):
            ...
            sims = model.predict([methnames,apiseqs,tokens,sbt,descs], batch_size=200).flatten()
    ...
    def eval(self, model, K):
        ...
        for i in range(data_len):
            ...
            n_results = K          
            sims = model.predict([methnames,apiseqs,tokens,sbt,descs], batch_size=400).flatten()
        ...
        f2=open('/data/dengzhongyang/StbCS/keras/results/eval_results.txt','a',encoding='utf-8',errors='ignore')
        f2.write('SuccRate={}, ACC={}, MRR={}, MAP={}, nDCG={}'.format(succrate,acc,mrr,map,ndcg))
        return succrate,acc,mrr,map,ndcg
